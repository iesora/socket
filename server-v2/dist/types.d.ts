...
export declare type TextFormat = 'markdown' | 'html';
...
export declare type RoomType = 'talk_room' | 'chat_group' | 'personal';
...
export declare type Answer = 'attendance' | 'absence' | 'on_hold';
export declare type MeetupStatusChoices = 'possible' | 'case-by-case' | 'impossible';
